...
with open(os.path.join(out_dir, 'q1e.txt'), "w+") as out_file:
    print("It can be observed that for learning rate of 0.001, gradient descent converged but for learning rate of 0.025 and 0.1, gradient descent overshoot the minima and diverged away.", file=out_file)
